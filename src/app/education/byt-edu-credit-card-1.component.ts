...
@Component({
	selector: 'byt-edu-credit-card-1',
	templateUrl: './byt-edu-credit-card-1.component.html',
	styleUrls: ['./byt-edu-credit-card-1.component.css']
})
export class BYTEDUCreditCard1 {
