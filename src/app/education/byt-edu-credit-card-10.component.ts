...
@Component({
	selector: 'byt-edu-credit-card-10',
	templateUrl: './byt-edu-credit-card-10.component.html',
	styleUrls: ['./byt-edu-credit-card-10.component.css']
})
export class BYTEDUCreditCard10 {
