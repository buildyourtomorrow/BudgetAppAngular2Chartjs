...
@Component({
	selector: 'byt-edu-credit-card-9',
	templateUrl: './byt-edu-credit-card-9.component.html',
	styleUrls: ['./byt-edu-credit-card-9.component.css']
})
export class BYTEDUCreditCard9 {
