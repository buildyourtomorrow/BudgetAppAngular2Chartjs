...
@Component({
	selector: 'byt-edu-credit-card-7',
	templateUrl: './byt-edu-credit-card-7.component.html',
	styleUrls: ['./byt-edu-credit-card-7.component.css']
})
export class BYTEDUCreditCard7 {
