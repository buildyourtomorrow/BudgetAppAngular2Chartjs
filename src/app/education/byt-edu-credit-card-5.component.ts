...
@Component({
	selector: 'byt-edu-credit-card-5',
	templateUrl: './byt-edu-credit-card-5.component.html',
	styleUrls: ['./byt-edu-credit-card-5.component.css']
})
export class BYTEDUCreditCard5 {
