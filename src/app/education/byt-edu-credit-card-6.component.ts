...
@Component({
	selector: 'byt-edu-credit-card-6',
	templateUrl: './byt-edu-credit-card-6.component.html',
	styleUrls: ['./byt-edu-credit-card-6.component.css']
})
export class BYTEDUCreditCard6 {
