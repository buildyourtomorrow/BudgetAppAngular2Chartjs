...
@Component({
	selector: 'byt-edu-credit-card-8',
	templateUrl: './byt-edu-credit-card-8.component.html',
	styleUrls: ['./byt-edu-credit-card-8.component.css']
})
export class BYTEDUCreditCard8 {
