...
@Component({
	selector: 'byt-edu-credit-card-4',
	templateUrl: './byt-edu-credit-card-4.component.html',
	styleUrls: ['./byt-edu-credit-card-4.component.css']
})
export class BYTEDUCreditCard4 {
