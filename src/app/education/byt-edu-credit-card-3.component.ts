...
@Component({
	selector: 'byt-edu-credit-card-3',
	templateUrl: './byt-edu-credit-card-3.component.html',
	styleUrls: ['./byt-edu-credit-card-3.component.css']
})
export class BYTEDUCreditCard3 {
